...
class CameraInterfaceImpl: CameraInterface {
    override fun getPosition(): Vector4f {
        TODO("Not yet implemented")
    }

    override fun getView(): Coordinate4D {
        TODO("Not yet implemented")
    }
    ...
    override fun moveRight(distance: Float) {
        TODO("Not yet implemented")
    }

    override fun moveUp(distance: Float) {
        TODO("Not yet implemented")
    }

    override fun moveAna(distance: Float) {
        TODO("Not yet implemented")
    }

    override fun moveForward(distance: Float) {
        TODO("Not yet implemented")
    }
