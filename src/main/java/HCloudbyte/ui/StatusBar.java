 ...
 * <ul>
 *   <li>CAM 坐标 → {@code RendererInterface.getCamera().getPos()}（§3.1.1 GET_CAMERA_POS）：AnimationTimer 每帧刷新 ✅</li>
...
public class StatusBar extends HBox {
    ...
    public StatusBar(RendererInterface renderer) {
        ...
        // 接口调用：每帧刷新摄像机坐标 ← RendererInterface.getCamera().getPos()（Kotlin 侧已实现）
